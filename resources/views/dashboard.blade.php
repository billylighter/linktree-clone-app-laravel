<x-app-layout>
    ...
    <div class="p-4" x-data="{
        ...
        <div class="flex justify-center items-center flex-col">
            ...
            <div x-show="copied" id="toast-success"
            ...
            <div class="flex">
                <button @click="copy" data-tooltip-target="tooltip-right" data-tooltip-placement="right"
                        class="inline-flex items-center justify-center p-5 text-base font-medium text-black rounded-lg bg-gray-200 hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                ...
                <a href="{{ '/' . $user->username }}" target="_blank"
                   data-tooltip-target="tooltip-right-2" data-tooltip-placement="right"
                        class="inline-flex items-center justify-center p-5 text-base font-medium text-black rounded-lg bg-gray-200 hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
                    ...
                    <div id="tooltip-right-2" role="tooltip"
                         class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700 capitalize">
                        <span x-text="'click to check profile'">
    ...
    self.links = data.links
        ...
        .catch(error => {
          // Handle any errors that occur during the request
            ...
            <div x-show="!!saved" id="toast-success"
                 class="flex fixed bottom-5 right-5 items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                 role="alert">
                <div
                    class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200">
